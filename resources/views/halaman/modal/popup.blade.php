  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-body">
       ...
       <div class="bg">
            <label id="atmc">Atomic mass:32.065 u</label>
       </div>
       <div>
            <label>Melting point:<span id="mtp">112.8°C (385.95 K)</span></label>
       </div>
       <div>
            <label>Boiling point:<span id="btp">444.6°C (717.75 K)</span></label>
       </div>
       </div>
      </div>
